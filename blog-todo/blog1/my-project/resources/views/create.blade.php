...
<h1 class="flex justify-center  font-bold  mt-8 mb-8 text-4xl text-gray-600">Create Record</h1>

<div class="flex justify-center  font-bold  mt-8 mb-8  text-gray-600 font-sans">


    <form class="" method='post' action='/create' name='contactform' id='contactform'>
        @csrf
        <p class=" flex items-center min-w-full  flex-col col-span-3 mx-auto">
            <label for='fullname'>Title:</label><br />
            <input class=" bg-yellow-300 border outline-0 rounded-md ml-4 w-80 pl-3 mb-10 " type='text'
                name='name' />
        ...
        <p>
            <textarea class="border rounded-lg bg-gray-200 px-4  outline-0" name="body" cols="70" rows="10"></textarea>
        </p>
        ...
        <input
            ...
            type='submit' name='submit' value='Submit Record' />
